...
//that Room uses to generate code in the background. I'll have to create an implementing class that's what will be used at runtime
//This is a Singleton class

@Database(entities = {Series.class, Seasons.class, Rating.class, EpisodeResponse.class, Episode.class, Details.class}, version = 1)   //entities -> comma delimited list of entity classes
